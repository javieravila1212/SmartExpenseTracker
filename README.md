...
## Usage
1. Open VS Code. Select Project file. Install pandas library to read CSV file by typing at terminal: pip install pandas

1. Create a budget.py file. Insert code from https://www.freecodecamp.org/news/build-smart-expense-tracker-with-python-and-llms/
